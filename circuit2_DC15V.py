...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 12:45:42 2023
...
R,u_R,I,u_I,V,u_V,V_infinite,u_V_infinite = np.loadtxt('/Users/nicoleevans/phy224/Circuit 2 DC 15V.csv', skiprows=1, delimiter=',',unpack=True)
...
plt.title('Voltage vs Current of 15V DC Power Supply')
