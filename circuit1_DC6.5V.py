...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 11:55:27 2023
...
R,u_R,I,u_I,V,u_V,V_infinite,u_V_infinite = np.loadtxt('/Users/nicoleevans/phy224/Circuit 1 DC 6.5V.csv', skiprows=1, delimiter=',',unpack=True)
...
plt.title('Voltage vs Current for 6.5V DC Power Supply')
