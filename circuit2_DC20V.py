...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 12:48:13 2023
...
R,u_R,I,u_I,V,u_V,V_infinite,u_V_infinite = np.loadtxt('/Users/nicoleevans/phy224/Circuit 2 DC 20V.csv', skiprows=1, delimiter=',',unpack=True)
...
plt.title('Voltage vs Current of 20V DC Power Supply')
