...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 10:54:56 2023
...
R,u_R,I,u_I,V,u_V,V_infinite,u_V_infinite = np.loadtxt('/Users/nicoleevans/phy224/Circuit 1 battery.csv', skiprows=1, delimiter=',',unpack=True)
