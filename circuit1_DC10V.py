...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 12:19:16 2023
...
R,u_R,I,u_I,V,u_V,V_infinite,u_V_infinite = np.loadtxt('/Users/nicoleevans/phy224/Circuit 1 DC 10V.csv', skiprows=1, delimiter=',',unpack=True)
...
plt.title('Voltage vs Current for 10V DC Power Supply')
